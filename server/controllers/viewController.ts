...
export async function getTable(
    ...
    try {
        ...
        const table = await new Promise((resolve, reject) => {
            conn.query(ViewQueries.GET_TABLE_BY_LEAGUE_ID, [params.leagueId, currentSeason], (err, result) => {
                if (err) {
                    return reject(err);
                }
...
export async function getGames(
    ...
    try {
        ...
        const games = await new Promise((resolve, reject) => {
            conn.query(ViewQueries.GET_GAMES_BY_GAMES_BY_TEAM_ID, [params.teamId, getCurrentSeason()], (err, result) => {
                if (err) {
                    return reject(err);
                }
...
export async function getGameEvents(
    ...
    try {
        ...
        const events = await new Promise((resolve, reject) => {
            conn.query(ViewQueries.GET_GAME_EVENTS_BY_GAME_ID, [params.gameId], (err, result) => {
                if (err) {
                    return reject(err);
                }
